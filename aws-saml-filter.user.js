...
// @description Adds account list filter to AWS SSO signin page
...
$("#searchbox > input").keyup(function (e) {
    if (e.keyCode === 40) {
        $("fieldset > div.saml-account:visible > div.saml-account > div.saml-role:visible").first().children("input").focus()
        $("fieldset > div.saml-account:visible > div.saml-account > div.saml-role:visible").first().children("input").prop("checked", true)
        return
    }
    if ($(this).val() == "") {
